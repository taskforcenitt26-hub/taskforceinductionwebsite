    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-white py-12">
        <div className="container-max">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 text-center justify-items-center">
            <div>
            ...
            <div>
              <div className="text-3xl font-bold text-yellow-600 mb-2">{managers.length}+</div>
