...
import heroBg from '../../assests/Websiteopen.webp';
...
const Home = () => {
  ...
  return (
    <div>
      ...
      {/* Upcoming Events */}
      <section id="upcoming-events" className="bg-gray-900 py-16">
        <div className="container-max px-4 mx-auto">
          ...
          <div className="relative md:hidden">
            ...
            {upcomingEvents.length > 0 && (
              <div className="bg-gray-800 p-6 rounded-lg hover:shadow-md transition-shadow duration-200 text-white">
          ...
          <div className="hidden md:grid grid-cols-3 gap-8">
            {upcomingEvents.map((event) => (
              <div key={event.id} className="bg-gray-800 p-6 rounded-lg hover:shadow-md transition-shadow duration-200 text-white">
                <div className="text-yellow-600 font-semibold mb-2">{event.date}</div>
                <h3 className="event-title text-xl font-semibold mb-3 text-white">
                  {event.title}
                </h3>
                <p className="text-gray-200 mb-4">
                  {event.description}
